  ...
  return (
    <section>
      ...
      <PrimaryButton onClick={() => setCfg((c) => ({
        ...
        redeem: { ...c.redeem, allowPartial, allowSplitTender: allowSplit, increment },
  ...
  return (
    <section>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <SummaryCard title="Program rules — Redeem & expiry" lines={[`Point value: $${cfg.basics.pointValue.toFixed(2)}/pt`, `Increment: ${cfg.redeem.increment} pts`, `Exclusions: ${cfg.redeem.exclusions.join(", ")}`, `Expiry: ${cfg.expiry.months} months; grace ${cfg.expiry.graceEmailDays} days; auto-extend ${cfg.expiry.autoExtend ? "on" : "off"}`]} />
